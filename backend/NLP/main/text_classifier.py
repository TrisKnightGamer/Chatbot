...
data_path = root_dir + '/backend/NLP/data/processed_data4.csv' #/backend/NLP
#data_path = '/Volumes/ESD-USB/share/chatobt/backend/NLP/data/processed_data3.csv'
word2vec_model = Word2Vec.load(root_dir + '/backend/NLP/models/VNCorpus7.bin') #/backend/NLP
keras_text_classifier = TextClassifier(word2vec_dict=word2vec_model, model_path=root_dir + '/backend/NLP/models/sentiment_model7.h5', #/backend/NLP
